#PostBot
Vi har gjort ett program som använder sig av Reddits API. Denna så kallade bots mål är att kommentera på trådar som har skrivits på ett specifikt subreddit. Programmet arbetar i flera olika steg varje gång den ska hämta information.
